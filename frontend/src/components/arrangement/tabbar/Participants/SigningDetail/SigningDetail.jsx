...
export const SigningDetail = ({ open, participants, handleClose }) => {
    ...
    info: [
      {
        ...
        subtitle: participants.signing_purpose
          ? participants.signing_purpose
          : "Signature",
      },
      {
        title: t("0-common.company"),
        subtitle: participants.metaInformation.company
          ? participants.metaInformation.company
          : null,
      },
      {
        title: t("0-common.Position"),
        subtitle: participants.metaInformation.position
          ? participants.metaInformation.position
          : null,
      },
      {
        title: t("0-common.Structural subdivision"),
        subtitle: participants.metaInformation.structural_subdivision
          ? participants.metaInformation.structural_subdivision
          : null,
      },
      {
        title: t("0-common.Location"),
        subtitle: participants.metaInformation.country
          ? participants.metaInformation.country
          : null,
      },
      {
        title: t("0-common.Reason"),
        subtitle: participants.customReason ? participants.customReason : null,
      },
              ...
              {status === 2 ? (
                ...
                <>
                  ...
                  >
                    ...
                    {participants.signerType === 2 && t("signing.wait_approve")}
                    {participants.signerType === 3 &&
                      t("signing.signature_valid")}
                    {participants.signerType === 5 && t("signing.only_view")}
                  </Typography>
                </>
              )}
            </AccordionSummary>
