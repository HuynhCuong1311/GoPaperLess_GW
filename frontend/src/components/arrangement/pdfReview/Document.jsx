  ...
  return (
    <div
      style={{
        ...
        overflow: "hidden",
        pointerEvents: workFlow.workflowStatus == 0 ? "auto" : "none",
      }}
    ...
    >
      ...
      {hyperlinkField?.map((hyperlinkData, index) => {
        if (hyperlinkData.page !== props.pageIndex + 1) return null;
        return (
          <HyperlinkField
            key={index}
            index={index}
      ...
      {documentIDField?.map((documentIDData, index) => {
        if (documentIDData.page !== props.pageIndex + 1) return null;
        return (
          <DocumentIDField
            key={index}
            index={index}
