  ...
  return (
    <>
      <Draggable
        ...
        disabled={
          (hyperlinkData.remark && !hyperlinkData.remark.includes(signerId)) ||
          hyperlinkData.process_status === "PROCESSED"
        }
      >
        <ResizableBox
          ...
          onResizeStop={async (e, { size }) => {
            // console.log("e: ", e);
            if (
              hyperlinkData.remark &&
              !hyperlinkData.remark.includes(signerId)
            )
              return;
        ...
        >
          <Box
            ...
            sx={{
              backgroundColor: hyperlinkData.verification
              ...
              border: "2px dashed",
              borderColor: hyperlinkData.verification ? "black" : "#EAB308",
            }}
            onMouseMove={() => {
              setShowTopbar(true);
            }}
          ...
          >
            <Tooltip title={hyperlinkData.tool_tip_text} placement="bottom">
              ...
              >
                ...
                <Typography>{hyperlinkData.place_holder}</Typography>
              </Stack>
            </Tooltip>
          </Box>
        </ResizableBox>
